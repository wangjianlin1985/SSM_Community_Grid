...
<!--startprint-->
	 ...
	 pagination="true" url="../getUyijians?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="uyijianImgName" width="20" formatter="formatXiazai">日志</th>
				<th field="uyijianMark1" width="60">评价</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanUyijian()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传日志</a>
		</div>
	</div>
<!--endprint-->
	...
	<div id="dlg" class="easyui-dialog" style="width: 380px;height: 260px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
					<td valign="top">详情：</td>
					<td><textarea rows="7" cols="30" name="uyijianMark" id="uyijianMark"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
